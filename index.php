  ...
  <div id="wrapper">
    ...
    <section id="intro">
      <div class="intro-content">
        <h2>Welcome to Your Voice Is Heard!</h2>
        <h3>Justice is served to the voices that speak out to the world</h3>
        <div>
          <a href="re.php" class="btn-get-started scrollto">Get Started</a>
        </div>
		<br><br><br><br>
		<div>
